...
import { MdDashboard, MdPeople, MdHotel, MdDescription, MdHealthAndSafety, MdChevronLeft, MdChevronRight } from "react-icons/md";
...
const Navigation = () => {
    ...
    useEffect(() => {
        fetchPendingActions();
        const interval = setInterval(fetchPendingActions, 20000);
        ...
        `}>
                    ...
                    <div className="flex flex-col gap-8 w-full">
                        ...
                        <div className="p-6 border-b border-slate-800">
                            <div onClick={() => navigate('/nurse')} className="cursor-pointer flex items-center gap-4">
                        ...
                        <nav className="flex flex-col gap-1.5 w-full">
                            {tabs.map((tab) => {
                                const isTabActive = location.pathname.startsWith(`/nurse/${tab.id}`);
